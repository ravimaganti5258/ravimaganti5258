...
import { pricing } from '../../../assets/jsonData/index.js';
...
const AddPricing = ({ navigation, route }) => {
        ...
        <View>
          ...
          <View style={styles.bottomView}>
            ...
            {selectedUnitDropDown?.value === 'Each' ||
              selectedPriceTypeDropDown?.label === 'Miscellaneous Parts' ? (
              <Text style={{
                flex: 0.5, marginTop: 0, marginRight: I18nManager.isRTL ? normalize(20) : normalize(0),
              }}>${parseFloat(qty * unitPrice).toFixed(2)}</Text>
            ) : null}
            {selectedUnitDropDown?.value === 'Hourly' && selectedPriceTypeDropDown?.label !== 'Miscellaneous Parts' ? (
              <Text style={{ flex: 0.5, marginTop: 0, marginRight: I18nManager.isRTL ? normalize(20) : normalize(0) }}>
                $
...
const styles = StyleSheet.create({
  ...
  textInput1: {
    ...
    // paddingLeft: I18nManager.isRTL ? normalize(0) : normalize(10),
    // paddingRight: I18nManager.isRTL ? normalize(0) : normalize(0),
